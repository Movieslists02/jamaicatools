    ...
    <div className="w-full max-w-full overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-lg">
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        ...
        <button
          onClick={copyResults}
          disabled={!result}
          className="h-14 rounded-xl border border-blue-300 px-8 font-semibold text-blue-700 hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-40"
        >
          📋 Copy Results
        </button>
      </div>
      ...
      {message && (
  <div className="mt-6 rounded-xl border border-green-200 bg-green-50 p-4 text-green-700 font-medium">
    {message}
  </div>
)}
      {error && (
          ...
          <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-6">
            ...
            <div className="mt-5 divide-y divide-slate-200">
              {[
                ...
                ["NIS", result.nis, "text-indigo-700"],
