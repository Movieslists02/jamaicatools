...
`;
  ...
  const calculateSalary = () => {
    ...
    const educationTaxResult = calculateEducationTax(annualSalary, nisAnnual);

    const educationTaxAnnual = educationTaxResult.annualContribution;
